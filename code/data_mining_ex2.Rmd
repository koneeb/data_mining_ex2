...
The model baseline3 uses all the possible predictors except the arrival_date variable and includes the interaction between adults and average_daily_rate.
